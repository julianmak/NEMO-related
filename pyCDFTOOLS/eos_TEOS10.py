...
#  !!        ***should*** be able to just overwrite the existing "eos" and 
#  !!        work
#  !!----------------------------------------------------------------------
...
def sigmai_dep(CT, SA, p):
  """
  Compute the density referenced to p from CONSERVATIVE temperature and ABSOLUTE
  salinity fields using the TEOS-10 equation of state
  ...
  Returns:
    sigmai_dep_out = density referenced to p using TEOS-10 eos
